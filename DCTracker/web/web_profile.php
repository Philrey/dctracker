...
<html>
    ...
    <?php
        if(isset($_COOKIE['userId']) && isset($_GET['id'])){
            echo '<body onload="initScripts4('.$_COOKIE['userId'].','.$_GET['id'].');">';
        }else{
            redirectPage("../index.php",0);
        }
    ?>
    ...
    <!-- pageheader  -->
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h1 class="pageheader-title">Taxi Profile</h1> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <span class="card">
                            <h5 class="card-header">Data Table
                            </span>
                            <h5 class="card-header">
       <div class="roundedSquareTest" style="background-color: #fff">
            <table>
                <tr>
                    <td style="color: #3d405c">Taxi Name:</td>
                    <td id="taxiName"><small>Loading </small><img src="../images/loadingBars/loading_3bars.gif" alt=""></td>
                </tr>
                <tr>
                    <td style="color: #3d405c">Plate Number:</td>
                    <td id="taxiPlateNumber"><small>Loading </small><img src="../images/loadingBars/loading_3bars.gif" alt=""></td>
                </tr>
            </table>
        </div></h5>
            <!-- Violation History -->
            <div class="roundedSquareTest top" style="background-color: #fff; margin-left:21px;margin-top: 11px">
                <button onclick="searchViolations();" class="btn btn-primary">Refresh</button>
            </div>
        ...
        <!--ViolationHistory-->
        <!-- <div class="roundedSquareTest">
            <button onclick="searchViolations();">Refresh</button>
            ...
            <div class="overflowContents" style="width:1000px;height:400px;">
                <table  id="searchResult" style="width:100%;" class="">
                    ...
                    <tr>
                        ...
                        <td class="center" style="width:80px;">
                            <small>0.2342342</small><img src="../images/loadingBars/loading_3bars.gif" alt="">
                        </td>
                        <td class="center" style="width:80px;">
                            <small>0.2342342</small><img src="../images/loadingBars/loading_3bars.gif" alt="">
                        </td>
